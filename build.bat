...
if %ERRORLEVEL% equ 0 (
    copy /Y "build\gdtune\Debug\gdtune.dll" "godot_test_project\bin\"
    "C:\MyData\Works40s\Godot\Godot_v4.3-stable_win64.exe\Godot_v4.3-stable_win64.exe" --path "./godot_test_project/" --verbose
) else (
    echo "Build Error!!"
)
